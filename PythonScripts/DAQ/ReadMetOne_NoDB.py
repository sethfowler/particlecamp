...
while 1:
    ...
    #Timestamp = time.strptime(LineArray[0], "%d-%b-%Y %H:%M:%S")
    #Timestamp = psycopg2.Timestamp(Timestamp.tm_year, Timestamp.tm_mon, Timestamp.tm_mday, Timestamp.tm_hour, Timestamp.tm_min, Timestamp.tm_sec)
